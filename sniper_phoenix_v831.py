...
"""
SNIPER PHOENIX v8.3.1 - HÍBRIDO CORRIGIDO (REVERSÃO + TREND FOLLOWING)
...
def thread_visual():
    while True:
        if not menu_ativo:
            ...
            print(f"{Fore.CYAN}🐦‍🔥 SNIPER PHOENIX v8.3.1 - HÍBRIDO CORRIGIDO {Fore.WHITE}| UPTIME: {uptime}")
